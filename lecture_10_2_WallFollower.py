...
DEFAULT_WALL_DIST = 0.05    # Default distance from wall = 20cm
DEADBAND = 0.02            # Deadband is 2cm
DEFAULT_SPEED = 100        # Default speed = 150dps
DEFAULT_DELTA_SPEED = 66   # Default delta change in speed = 100dps
